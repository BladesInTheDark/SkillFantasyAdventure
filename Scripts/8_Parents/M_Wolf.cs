...
public class M_Wolf : Monster
{
    public const eMonster ownType = eMonster.Wolf;

    public M_Wolf(stStatus st) : base(st)
    {
        type = st.type;
        atk = st.atk;
        dfn = st.dfn;
    ...
    public void InitSet(stStatus st, stTilePos stp)
    {
        ...
        skills.Add(SkillManager.m.mSkillDict[(int)eMSkillCode.MPS_1011_Wolf_Passive]);
        skills.Add(SkillManager.m.mSkillDict[(int)eMSkillCode.MAS_1012_Wolf_Attack]);
        skills.Add(SkillManager.m.mSkillDict[(int)eMSkillCode.MAS_1013_Wolf_Scratch]);
        skills.Add(SkillManager.m.mSkillDict[(int)eMSkillCode.MAS_1014_Wolf_Tackle]);
        skills.Add(SkillManager.m.mSkillDict[(int)eMSkillCode.MAS_1015_Wolf_Bite]);
