...
// 스킬관리에서 액티브 스킬 칸을 담당하는 클래스
public class SkillMng_Active : MonoBehaviour, IDropHandler
{
    ...
    private void Awake()
    {
        ownSkill = SkillManager.m.asb[ownIdx];
        if (ownSkill == null)
        {
    ...
    public void OnDrop(PointerEventData eventData)
    {
        ...
        if (skillIcon != null)
        {
            ...
            skillIcon.wnd.ASkillIn(this, skillIcon.ownSkill.code, ownIdx);
            return;
        }
    }
